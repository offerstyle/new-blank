...
$(window).scroll(function() {
    if ($(this).scrollTop() > a && t.hasClass("passive")) {
        t.removeClass("passive").addClass("active");
    } else if ($(this).scrollTop() <= a && t.hasClass("active")) {
        t.removeClass("active").addClass("passive");
    }
});    
});
...
//        geometry: {
//            type: "Point",
//            coordinates: [55.590302, 37.626618]
//        },
//        properties: {
